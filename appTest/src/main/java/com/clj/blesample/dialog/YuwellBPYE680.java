...
/**
 * Autor: Administrator
 * CreatedTime: 2020/7/3 0003
 * UpdateTime:2020/7/3 0003 8:59
 * Des:鱼跃数据解析
 * UpdateContent:
 **/
public class YuwellBPYE680 extends Dialog {
    ...
    public YuwellBPYE680(@NonNull Context context) {
        super(context);

    }

    public YuwellBPYE680(@NonNull Context context, int themeResId) {
    ...
    private void startService() {
        if (TextUtils.isEmpty(mac)) {
            BluetoothDeviceService.startActionBaz(getContext(), new String[]{"Yuwell BP-YE680"}, null);
        } else {
